...
TEST(ComputationsTest, TransposeNonSquare) {
    tdm::mat<4, 2, int> m{tdm::vec2<int>{1, 1}, tdm::vec2<int>{2, 2}, tdm::vec2<int>{3, 3}, tdm::vec2<int>{4, 4}};
...
TEST(ComputationsTest, DeterminantMat3) {
    tdm::mat3<int> m{tdm::vec3<int>{2, -3, 1}, tdm::vec3<int>{2, 0, -1}, tdm::vec3<int>{1, 4, 5}};
    auto res = tdm::determinant(m);
    ASSERT_EQ(res, 49);
}
...
TEST(ComputationsTest, InverseMat3) {
    tdm::mat3<int> m{tdm::vec3<int>{1, 2, 3}, tdm::vec3<int>{0, 1, 4}, tdm::vec3<int>{5, 6, 0}};
    auto mi = tdm::inverse(m);
...
TEST(ComputationsTest, InverseMat4) {
    ...
    auto mi = tdm::inverse(m);
    tdm::mat4<float> expected{tdm::vec4<float>{3.9649f, 1.4035f, -1.9298f, -2.7017f},
...
TEST(ComputationsTest, InverseMat7) {
    tdm::mat<7, 7, float> m{tdm::vec<7, float>{0.6f, 0.2f, 0.3f, 0.4f, 0.5f, 0.7f, 0.8f},
