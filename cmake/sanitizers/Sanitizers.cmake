...
function(enable_sanitizer_flags sanitize_option compile_flags_var link_flags_var)
    if(${sanitize_option} MATCHES "address")
        ...
        if(WIN32)
            ...
            set(${link_flags_var} "/ignore:4300,4302" PARENT_SCOPE)
        else()
...
function(sanitize_targets)
    ...
    if(NOT CMAKE_CXX_COMPILER_ID MATCHES "GNU" AND NOT CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND NOT CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
